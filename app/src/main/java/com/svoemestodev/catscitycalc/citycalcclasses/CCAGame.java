...
//        clone.setSsaArea(this.getSsaArea().getClone());
    ...
    public void updateFromDb(DbTeamGame dbTeamGame) {
        ...
        int index = 0;
        this.buildings[index].setPresent(dbTeamGame.isPresent_bld1());
        this.buildings[index].setX2(dbTeamGame.isX2_bld1());
        this.buildings[index].setMayX2(dbTeamGame.isMayX2_bld1());
        this.buildings[index].setBuildingIsOur(dbTeamGame.isBuildingIsOur_bld1());
        this.buildings[index].setBuildingIsEnemy(dbTeamGame.isBuildingIsEnemy_bld1());
        this.buildings[index].setBuildingIsEmpty(dbTeamGame.isBuildingIsEmpty_bld1());
        this.buildings[index].setOur_points(dbTeamGame.getOur_points_bld1());
        this.buildings[index].setEnemy_points(dbTeamGame.getEnemy_points_bld1());
        this.buildings[index].setSlots(dbTeamGame.getSlots_bld1());
        this.buildings[index].setSlots_our(dbTeamGame.getSlots_bld1_our());
        this.buildings[index].setSlots_enemy(dbTeamGame.getSlots_bld1_enemy());
        this.buildings[index].setSlots_empty(dbTeamGame.getSlots_bld1_empty());
        this.buildings[index].setNeedToWin(dbTeamGame.isNeedToWin_bld1());
        this.buildings[index].setNeedToWinWithoutX2(dbTeamGame.isNeedToWinWithoutX2_bld1());
        this.buildings[index].setNeedToEarlyWin(dbTeamGame.isNeedToEarlyWin_bld1());
        this.buildings[index].setNeedToEarlyWinWithoutX2(dbTeamGame.isNeedToEarlyWinWithoutX2_bld1());
        this.buildings[index].setUseInForecast(dbTeamGame.isUseInForecast_bld1());

        index = 1;
        this.buildings[index].setPresent(dbTeamGame.isPresent_bld2());
        this.buildings[index].setX2(dbTeamGame.isX2_bld2());
        this.buildings[index].setMayX2(dbTeamGame.isMayX2_bld2());
        this.buildings[index].setBuildingIsOur(dbTeamGame.isBuildingIsOur_bld2());
        this.buildings[index].setBuildingIsEnemy(dbTeamGame.isBuildingIsEnemy_bld2());
        this.buildings[index].setBuildingIsEmpty(dbTeamGame.isBuildingIsEmpty_bld2());
        this.buildings[index].setOur_points(dbTeamGame.getOur_points_bld2());
        this.buildings[index].setEnemy_points(dbTeamGame.getEnemy_points_bld2());
        this.buildings[index].setSlots(dbTeamGame.getSlots_bld2());
        this.buildings[index].setSlots_our(dbTeamGame.getSlots_bld2_our());
        this.buildings[index].setSlots_enemy(dbTeamGame.getSlots_bld2_enemy());
        this.buildings[index].setSlots_empty(dbTeamGame.getSlots_bld2_empty());
        this.buildings[index].setNeedToWin(dbTeamGame.isNeedToWin_bld2());
        this.buildings[index].setNeedToWinWithoutX2(dbTeamGame.isNeedToWinWithoutX2_bld2());
        this.buildings[index].setNeedToEarlyWin(dbTeamGame.isNeedToEarlyWin_bld2());
        this.buildings[index].setNeedToEarlyWinWithoutX2(dbTeamGame.isNeedToEarlyWinWithoutX2_bld2());
        this.buildings[index].setUseInForecast(dbTeamGame.isUseInForecast_bld2());

        index = 2;
        this.buildings[index].setPresent(dbTeamGame.isPresent_bld3());
        this.buildings[index].setX2(dbTeamGame.isX2_bld3());
        this.buildings[index].setMayX2(dbTeamGame.isMayX2_bld3());
        this.buildings[index].setBuildingIsOur(dbTeamGame.isBuildingIsOur_bld3());
        this.buildings[index].setBuildingIsEnemy(dbTeamGame.isBuildingIsEnemy_bld3());
        this.buildings[index].setBuildingIsEmpty(dbTeamGame.isBuildingIsEmpty_bld3());
        this.buildings[index].setOur_points(dbTeamGame.getOur_points_bld3());
        this.buildings[index].setEnemy_points(dbTeamGame.getEnemy_points_bld3());
        this.buildings[index].setSlots(dbTeamGame.getSlots_bld3());
        this.buildings[index].setSlots_our(dbTeamGame.getSlots_bld3_our());
        this.buildings[index].setSlots_enemy(dbTeamGame.getSlots_bld3_enemy());
        this.buildings[index].setSlots_empty(dbTeamGame.getSlots_bld3_empty());
        this.buildings[index].setNeedToWin(dbTeamGame.isNeedToWin_bld3());
        this.buildings[index].setNeedToWinWithoutX2(dbTeamGame.isNeedToWinWithoutX2_bld3());
        this.buildings[index].setNeedToEarlyWin(dbTeamGame.isNeedToEarlyWin_bld3());
        this.buildings[index].setNeedToEarlyWinWithoutX2(dbTeamGame.isNeedToEarlyWinWithoutX2_bld3());
        this.buildings[index].setUseInForecast(dbTeamGame.isUseInForecast_bld3());

        index = 3;
        this.buildings[index].setPresent(dbTeamGame.isPresent_bld4());
        this.buildings[index].setX2(dbTeamGame.isX2_bld4());
        this.buildings[index].setMayX2(dbTeamGame.isMayX2_bld4());
        this.buildings[index].setBuildingIsOur(dbTeamGame.isBuildingIsOur_bld4());
        this.buildings[index].setBuildingIsEnemy(dbTeamGame.isBuildingIsEnemy_bld4());
        this.buildings[index].setBuildingIsEmpty(dbTeamGame.isBuildingIsEmpty_bld4());
        this.buildings[index].setOur_points(dbTeamGame.getOur_points_bld4());
        this.buildings[index].setEnemy_points(dbTeamGame.getEnemy_points_bld4());
        this.buildings[index].setSlots(dbTeamGame.getSlots_bld4());
        this.buildings[index].setSlots_our(dbTeamGame.getSlots_bld4_our());
        this.buildings[index].setSlots_enemy(dbTeamGame.getSlots_bld4_enemy());
        this.buildings[index].setSlots_empty(dbTeamGame.getSlots_bld4_empty());
        this.buildings[index].setNeedToWin(dbTeamGame.isNeedToWin_bld4());
        this.buildings[index].setNeedToWinWithoutX2(dbTeamGame.isNeedToWinWithoutX2_bld4());
        this.buildings[index].setNeedToEarlyWin(dbTeamGame.isNeedToEarlyWin_bld4());
        this.buildings[index].setNeedToEarlyWinWithoutX2(dbTeamGame.isNeedToEarlyWinWithoutX2_bld4());
        this.buildings[index].setUseInForecast(dbTeamGame.isUseInForecast_bld4());

        index = 4;
        this.buildings[index].setPresent(dbTeamGame.isPresent_bld5());
        this.buildings[index].setX2(dbTeamGame.isX2_bld5());
        this.buildings[index].setMayX2(dbTeamGame.isMayX2_bld5());
        this.buildings[index].setBuildingIsOur(dbTeamGame.isBuildingIsOur_bld5());
        this.buildings[index].setBuildingIsEnemy(dbTeamGame.isBuildingIsEnemy_bld5());
        this.buildings[index].setBuildingIsEmpty(dbTeamGame.isBuildingIsEmpty_bld5());
        this.buildings[index].setOur_points(dbTeamGame.getOur_points_bld5());
        this.buildings[index].setEnemy_points(dbTeamGame.getEnemy_points_bld5());
        this.buildings[index].setSlots(dbTeamGame.getSlots_bld5());
        this.buildings[index].setSlots_our(dbTeamGame.getSlots_bld5_our());
        this.buildings[index].setSlots_enemy(dbTeamGame.getSlots_bld5_enemy());
        this.buildings[index].setSlots_empty(dbTeamGame.getSlots_bld5_empty());
        this.buildings[index].setNeedToWin(dbTeamGame.isNeedToWin_bld5());
        this.buildings[index].setNeedToWinWithoutX2(dbTeamGame.isNeedToWinWithoutX2_bld5());
        this.buildings[index].setNeedToEarlyWin(dbTeamGame.isNeedToEarlyWin_bld5());
        this.buildings[index].setNeedToEarlyWinWithoutX2(dbTeamGame.isNeedToEarlyWinWithoutX2_bld5());
        this.buildings[index].setUseInForecast(dbTeamGame.isUseInForecast_bld5());

        index = 5;
        this.buildings[index].setPresent(dbTeamGame.isPresent_bld6());
        this.buildings[index].setX2(dbTeamGame.isX2_bld6());
        this.buildings[index].setMayX2(dbTeamGame.isMayX2_bld6());
        this.buildings[index].setBuildingIsOur(dbTeamGame.isBuildingIsOur_bld6());
        this.buildings[index].setBuildingIsEnemy(dbTeamGame.isBuildingIsEnemy_bld6());
        this.buildings[index].setBuildingIsEmpty(dbTeamGame.isBuildingIsEmpty_bld6());
        this.buildings[index].setOur_points(dbTeamGame.getOur_points_bld6());
        this.buildings[index].setEnemy_points(dbTeamGame.getEnemy_points_bld6());
        this.buildings[index].setSlots(dbTeamGame.getSlots_bld6());
        this.buildings[index].setSlots_our(dbTeamGame.getSlots_bld6_our());
        this.buildings[index].setSlots_enemy(dbTeamGame.getSlots_bld6_enemy());
        this.buildings[index].setSlots_empty(dbTeamGame.getSlots_bld6_empty());
        this.buildings[index].setNeedToWin(dbTeamGame.isNeedToWin_bld6());
        this.buildings[index].setNeedToWinWithoutX2(dbTeamGame.isNeedToWinWithoutX2_bld6());
        this.buildings[index].setNeedToEarlyWin(dbTeamGame.isNeedToEarlyWin_bld6());
        this.buildings[index].setNeedToEarlyWinWithoutX2(dbTeamGame.isNeedToEarlyWinWithoutX2_bld6());
        this.buildings[index].setUseInForecast(dbTeamGame.isUseInForecast_bld6());
